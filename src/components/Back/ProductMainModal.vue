  ...
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="productModalLabel"><slot name="title"></slot></h5>
        ...
        <div class="row">
          <div class="col-sm-4">
            ...
            <div class="mb-3">
              ...
              <input type="file" id="customFile" class="form-control" ref="imageUpload1" @change="uploadFile">
            </div>
          ...
          <div class="col-sm-8">
            ...
            <div class="row gx-2">
              <div class="mb-3 col-md-6">
                ...
                <input type="number" class="form-control" id="origin_price" v-model.number="currentProduct.origin_price"
                placeholder="請輸入原價">
              </div>
              <div class="mb-3 col-md-6">
                <label for="price" class="form-label">*售價</label>
                <input type="number" class="form-control" id="price" v-model.number="currentProduct.price"
                placeholder="請輸入售價">
              </div>
            </div>
            <hr>
            <div class="mb-3">
              ...
              <textarea type="text" class="form-control" id="description" v-model="currentProduct.description"
            ...
            <div class="row">
              <div class="my-3 col-6">
                <div class="mb-3">
                  ...
                  <input type="file" id="customFile" ref="itemImages1" class="form-control" @change="uploadFileMultiple($event, 1)">
                </div>
                <img :src="currentProduct.imagesUrl[0]" alt="產品圖" class="img-fluid" v-if="currentProduct.imagesUrl">
                <img v-else :src="image1" alt="產品圖" class="img-fluid">
              </div>
              <div class="my-3 col-6">
                <div class="mb-3">
                  <input type="url" class="form-control" v-model="image2">
                  <input type="file" id="customFile" ref="itemImages2" class="form-control" @change="uploadFileMultiple($event, 2)">
                </div>
                <img :src="currentProduct.imagesUrl[1]" alt="產品圖" class="img-fluid" v-if="currentProduct.imagesUrl">
                <img v-else :src="image2" alt="產品圖" class="img-fluid">
              </div>
              <div class="my-3 col-6">
                <div class="mb-3">
                  <input type="url" class="form-control" v-model="image3">
                  <input type="file" id="customFile" ref="itemImages3" class="form-control" @change="uploadFileMultiple($event, 3)">
                </div>
                <img :src="currentProduct.imagesUrl[2]" alt="產品圖" class="img-fluid" v-if="currentProduct.imagesUrl">
                <img v-else :src="image3" alt="產品圖" class="img-fluid">
              </div>
              <div class="my-3 col-6">
                <div class="mb-3">
                  <input type="url" class="form-control" v-model="image4">
                  <input type="file" id="customFile" ref="itemImages4" class="form-control" @change="uploadFileMultiple($event, 4)">
                </div>
                <img :src="currentProduct.imagesUrl[3]" alt="產品圖" class="img-fluid" v-if="currentProduct.imagesUrl">
                <img v-else :src="image4" alt="產品圖" class="img-fluid">
              </div>
              <div class="my-3 col-6">
                <div class="mb-3">
                  <input type="url" class="form-control" v-model="image5">
                  <input type="file" id="customFile" ref="itemImages5" class="form-control" @change="uploadFileMultiple($event, 5)">
                </div>
                <img :src="currentProduct.imagesUrl[4]" alt="產品圖" class="img-fluid" v-if="currentProduct.imagesUrl">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-dark btn-hv-style" data-bs-dismiss="modal">取消</button>
        <button type="button" class="btn btn-primary btn-hv-style" @click="updateProduct(currentProduct)">儲存</button>
      </div>
    </div>
  </div>
</div>
