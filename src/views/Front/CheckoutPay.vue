     ...
     <div class="row justify-content-center">
      ...
      <div class="bg-light row justify-content-center p-4 my-4" v-if="order.is_paid">
        <div class="col-md-8 d-flex justify-content-center align-items-center">
          ...
          <div>
            <p>訂單查詢號碼，可至<router-link to="/orderSearch" class="text-primary">訂單查詢</router-link>查詢訂單紀錄</p>
      ...
      <div>
        ...
        <div class="bg-light p-md-5 p-3 d-flex row">
          <div class="col-md-7">
            ...
            <div class="col-12">
              <p><strong class="me-3">地址:&nbsp;&nbsp;</strong>{{ order.user.address }}</p></div>
            <div class="col-12">
              <p><strong class="me-3">留言:&nbsp;&nbsp;</strong>{{ order.message }}</p></div>
          </div>
          </div>
      ...
      <div class="text-end py-3" v-if="!order.is_paid">
        <button type="button" class="btn btn-lg btn-major" @click="payOrder">確認無誤，結帳付款<i class="fas fa-file-invoice-dollar ms-2"></i></button>
      </div>
      <div class="text-center py-3" v-if="order.is_paid">
        <router-link to="/" class="btn btn-lg btn-major" >回首頁<i class="fas fa-home ms-2"></i></router-link>
      </div>
     </div>
    </div>
  </div>
